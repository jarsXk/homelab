...
if [ $NAS = yes ]; then
  ...
  run_command "wget --header 'Accept: application/vnd.github.v3.raw' -O /etc/update-motd.d/70-custom-motd https://api.github.com/repos/jarsXk/homelab/contents/host/linux/automated/70-custom-motd.sh" "Error setting motd"
fi
