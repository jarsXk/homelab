...
PACKAGE_LIST="micro mc htop openssh-server ca-certificates bash tzdata curl wget zstd unzip sudo util-linux figlet bind-tools imagemagick musl-locales iperf3 fastfetch musl-locales tzdata"
