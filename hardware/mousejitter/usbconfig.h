...
#define USB_CFG_VENDOR_ID 0xda, 0x09
 ...
 * the implications!
 */
#define USB_CFG_DEVICE_ID 0xda, 0x09
 ...
 */
#define USB_CFG_VENDOR_NAME     'A','4','T','e','c','h',' ','C','o','.',' ','L','t','d'
 ...
 * details.
 */
#define USB_CFG_DEVICE_NAME     'B','l','o','o','d','y',' ','V','8',' ','M','o','u','s','e'
#define USB_CFG_DEVICE_NAME_LEN 15
/* Same as above for the device name. If you don't want a device name, undefine
 * the macros. See the file USB-IDs-for-free.txt before you assign a name if
 * you use a shared VID/PID.
 */
#define USB_CFG_SERIAL_NUMBER   'A','4','T','e','c','h',' ','C','o','.',' ','L','t','d',':','M','o','u','s','e'
#define USB_CFG_SERIAL_NUMBER_LEN   20
